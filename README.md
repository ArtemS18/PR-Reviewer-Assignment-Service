...
Сделаны стресс-тесты locusto (см ниже)
Написан скрипт для их автоматического запуска
Реализованна массовая деактивация в команде по ручке ```/team/deactivate``` и безопасной замене PK (из числа всех пользователей)
